 ...
 ╚═╝     ╚═╝  ╚═╝ ╚═════╝  ╚════╝ ╚══════╝ ╚═════╝   ╚═╝   ╚══════╝
    ...
    <div id="projects-grid">
      ...
      <div class="project-card locked">
        ...
        <div class="project-description">
          A mesmerizing matrix rain simulator with customizable parameters. Watch digital rain cascade through your terminal with authentic green phosphor aesthetics.
        </div>
        <div class="project-tags">
          <span class="project-tag">visual</span>
          <span class="project-tag">matrix</span>
          <span class="project-tag">animation</span>
          <span class="project-tag">retro</span>
        </div>
        <div class="project-action">
          INITIALIZING...
        </div>
  ...
  <div id="terminal-footer">
    <div class="footer-stat">
      PROJECTS: <span class="value">1</span>/3 AVAILABLE
    </div>
    <div class="footer-stat">
