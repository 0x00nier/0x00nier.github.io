# -*- encoding: utf-8 -*-
# stub: metainspector 5.16.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<nokogiri>.freeze, ["~> 1.18.8".freeze])
  ...
  s.add_runtime_dependency(%q<faraday-gzip>.freeze, [">= 0.1".freeze, "< 3.0".freeze])
  ...
  s.add_development_dependency(%q<puma>.freeze, ["~> 6.4.0".freeze])
